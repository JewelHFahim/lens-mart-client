...
const AllProducts = () => {
  ...
  return (
    <div>
      ...
      {/* Camera Section */}
      <h2 className="text-2xl bg-slate-300 p-2 mx-4 mb-2 mt-5 text-center">Cameras</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5 mx-4 mb-4">
      {
        ...
        <div className="card bg-base-120 shadow-xl border border-slate-300">
          <figure>
            <img style={{ width: "100px" }} src={camera.products.img} alt="Shoes" />
          </figure>
      ...
      {/* Lens*/}
      <h2 className="text-2xl bg-slate-300 p-2 mx-4 mb-2 mt-5 text-center">Lens</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5 mx-4 mb-4">
      {
        lens.map((len) => (
        <div className="card bg-base-120 shadow-xl border border-slate-300">
          <figure>
            <img style={{ width: "100px" }} src={len.products.img} alt="Shoes" />
          </figure>
          <div className="px-5 pb-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5 mx-4 mb-4">
      {
        ...
        <div className="card bg-base-120 shadow-xl border border-slate-300">
          <figure>
            <img style={{ width: "100px" }} src={acces.products.img} alt="Shoes" />
          </figure>
          <div className="px-5 pb-5">
