...
const handleAddLens = (data, event) => {
  ...
  return (
    <div>
      ...
      <input type="checkbox" id="my-lens" className="modal-toggle" />
      <div className="modal">
        <div className="modal-box w-11/12 max-w-5xl">
          <h3 className="font-bold text-lg">Add Lens</h3>
          <form className="card-body" onSubmit={handleSubmit(handleAddLens)}>
            {/* 1st row */}
            ...
            <label htmlFor="my-lens" className="btn btn-primary btn-sm btn-circle absolute right-2 top-2">✕</label>
            <div className="form-control modal-action mt-6">
              <button htmlFor="my-lens" className="btn btn-primary">Submit</button>
            </div>
