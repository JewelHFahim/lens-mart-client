...
const SellerDashboard = () => {
  ...
  return (
    <div className="text-center">
      ...
      <label htmlFor="my-camera" className="btn btn-outline btn-primary mx-2">
        <FaCamera className="mr-2" /> Cameras
      </label>
      <label htmlFor="my-lens" className="btn mx-2 btn-outline btn-primary">
        {" "}
        <FaBullseye className="mr-2" /> Lens
      </label>
      <label
      ...
      >
        {" "}
        <FaTools className="mr-2" /> Accessories
      </label>
