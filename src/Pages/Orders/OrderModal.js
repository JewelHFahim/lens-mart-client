...
const { title, sale, _id, img } = details;
    ...
    <div>
      ...
      <div className="modal">
        <div className="modal-box w-8/12 max-w-5xl">
          <h3 className=" text-lg text-center">Booking: <span className="font-bold">{title}</span> </h3>
          <h3 className=" text-lg text-center">$ {sale}</h3>
          <form className="card-body" onSubmit={handleSubmit(handleOrder)}>

            <div className="flex items-center">
            <div className="form-control w-full">
              <input {...register("name")} defaultValue={user?.displayName} readOnly type="text" placeholder="title" className="input input-bordered" />
            </div>
            <div className="form-control w-full ml-4">
              <input {...register("email")} defaultValue={user?.email} readOnly type="text" placeholder="brand" className="input input-bordered" />
            </div>
            </div>
            ...
            <div className="form-control w-full">
              ...
              <input {...register("phone")} required type="text" placeholder="Phone Number" className="input input-bordered" />
            </div>
            <div className="form-control w-full ml-4">
              <label className="label"> <span className="label-text">Meeting Location</span> </label>
              <input {...register("location")} required type="text" placeholder="Meeting location" className="input input-bordered" />
            </div>
            </div>
