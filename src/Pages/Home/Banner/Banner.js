...
import img2 from "../../../Assets/slider/slide5.jpg";
      ...
      <div className="carousel w-full my-10">
        ...
        <div id="slide1" className="carousel-item relative w-full">
          ...
          <div className="absolute transform -translate-y-1/2 left-2/3 top-1/2 text-center pb-10" >
            ...
            <p className="text-lg text-orange-700">LOWEST PRICE OF THE SEASON</p>
        ...
        <div id="slide2" className="carousel-item relative w-full">
          <img style={{ height: "440px" }} src={img3} className="w-full" alt=""/>
